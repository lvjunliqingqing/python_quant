...
class PortfolioStrategyManager(QtWidgets.QWidget):
    ...
    def add_strategy(self):
        ...
        parameters_chinese = self.strategy_engine.get_strategy_class_parameters_chinese(class_name)
...
class StrategyManager(QtWidgets.QFrame):
    ...
    def edit_strategy(self):
        ...
        parameters_chinese = self.strategy_engine.get_strategy_parameters_chinese(strategy_name)
...
class SettingEditor(QtWidgets.QDialog):
    ...
    def init_ui(self):
        ...
        if self.class_name:
            ...
            parameters_chinese = {"strategy_name": "strategy_name", "vt_symbols": "vt_symbols"}
