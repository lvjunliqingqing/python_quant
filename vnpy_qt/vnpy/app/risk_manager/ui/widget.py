...
class RiskManager(QtWidgets.QDialog):
    ...
    def init_ui(self):
        ...
        self.account_limit_spin = RiskManagerSpinBox()
        self.one_variety_limit_spin = RiskManagerSpinBox()
        ...
        form.addRow("账户资金可使用率(%)", self.account_limit_spin)
        form.addRow("单品资金可使用率(%)", self.one_variety_limit_spin)
    ...
    def save_setting(self):
        ...
        setting = {
            ...
            "account_funds_availability_rate_limit": self.account_limit_spin.value(),
            "one_variety_money_rate_limit": self.one_variety_limit_spin.value(),
        }
    ...
    def update_setting(self):
        ...
        self.account_limit_spin.setValue(setting["account_funds_availability_rate_limit"])
        self.one_variety_limit_spin.setValue(setting["one_variety_money_rate_limit"])
