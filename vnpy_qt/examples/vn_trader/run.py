# flake8: noqa
from vnpy.app.k_line_playback import PlayBackChartApp
# from vnpy.app.paper_account import PaperAccountApp
from vnpy.app.market_radar import MarketRadarApp
from vnpy.app.multiple_varieties_backtest import MultipleVarietiesBackTestApp
from vnpy.app.portfolio_backtester import PortfolioBacktesterApp

from vnpy.app.manual_position_adjustment import ManualPositionAdjustmentApp
from vnpy.app.spread_backtester import SpreadBacktesterApp
...
def main():
    ...
    main_engine.add_app(MultipleVarietiesBackTestApp)
    # main_engine.add_app(OptionMasterApp)
    main_engine.add_app(ChartWizardApp)
    main_engine.add_app(PlayBackChartApp)
    # main_engine.add_app(ExcelRtdApp)
    # main_engine.add_app(DataManagerApp)
    main_engine.add_app(PortfolioStrategyApp)
    main_engine.add_app(SpreadBacktesterApp)
    # main_engine.add_app(PaperAccountApp)
    main_engine.add_app(ManualPositionAdjustmentApp)
