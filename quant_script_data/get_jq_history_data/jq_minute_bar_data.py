...
if __name__ == '__main__':
    symbol_list = [i.symbol for i in SecuritiesInfoModel.select().where((SecuritiesInfoModel.name_code ** "%8888%") | (SecuritiesInfoModel.name_code ** "%9999%"))]
    print(symbol_list)
    ...
    # df = get_price(symbol_list, start_date='2020-12-20', end_date='2021-3-21 23:00:00', frequency='minute',
