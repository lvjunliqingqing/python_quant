...
def dispose_csv_data(symbol):
    filename = f"{symbol}分笔.csv"
    dir_name = f"E:/jobs/通达信数据/2021-07-21/"
    # dir_name = f"E:/jobs/通达信数据/{datetime.datetime.now().date()}/"
    ...
    chip_df["datetime"] = "2021-07-21"  # 添加交易日期
    ...
    chip_df['vt_symbol'] = symbol_dict[symbol]
...
if __name__ == '__main__':
    symbols = ["RU2109", "IC2109", "RB2110", "A2109", "B2109", "SR2109", "C2109"]
    for symbol in symbols:
        df = dispose_csv_data(symbol)
        print(df)
