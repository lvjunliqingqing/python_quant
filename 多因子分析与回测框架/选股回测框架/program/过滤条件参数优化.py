...
# print(final_data[final_data['Ticker']=='ZN9999.XSGE'])
# exit()
    ...
    for begin_date in ['2015-01-05', '2015-01-06', '2015-01-07', '2015-01-08', '2015-01-09', '2015-01-10', '2015-01-13',
        ...
        for period_type in [1, 2, 3, 4, 5, 6, 8, 9]:
            for fangxiang in fangxiang_list:
                ...
                # 添加过滤条件
                if fangxiang == 'long':
                    final_data1 = final_data[final_data['Close'] > final_data['ma20']]
                    final_data1 = final_data1[final_data1['net_position'] > 0]

                else:
                    final_data1 = final_data[final_data['Close'] < final_data['ma20']]
                    final_data1 = final_data1[final_data1['net_position'] < 0]

                select_stock, equity = get_backtest_equity_and_select_stock_data(final_data1, is_trade_date,
                                                                                 index_alldata,
                                                                                 params_dict)
                if fangxiang == 'long':
                    good_equity = equity
