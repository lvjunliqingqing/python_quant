...
from vnpy.app.cta_strategy import (
    ...
    BacktestingEngine,
    OptimizationSetting)
from vnpy.app.multiple_varieties_backtest.base import EVENT_MULTIPLE_VARIETIES_BACK_OPTIMIZATION_FINISHED, APP_NAME, \
    EVENT_MULTIPLE_VARIETIES_BACK_TEST_LOG, EVENT_MULTIPLE_VARIETIES_BACK_TEST_FINISHED
...
class MultipleVarietiesBackTestEngine(BaseEngine):
    """
    多合约品种回测引擎
    """
    ...
    def write_log(self, msg: str):
        """"""
        event = Event(EVENT_MULTIPLE_VARIETIES_BACK_TEST_LOG)
        event.data = msg
    ...
    def run_backtesting(
        ...
        event = Event(EVENT_MULTIPLE_VARIETIES_BACK_TEST_FINISHED)
        self.event_engine.put(event)
    ...
    def run_optimization(
        ...
        event = Event(EVENT_MULTIPLE_VARIETIES_BACK_OPTIMIZATION_FINISHED)
        self.event_engine.put(event)
