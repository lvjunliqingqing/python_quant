...
class BacktestingEngine:
    ...
    def cross_limit_order(self):
        ...
        # lv jun个人所加
        num = len(self.active_limit_orders.values())
        # 结束

        for order in list(self.active_limit_orders.values()):
            # Push order update with status "not traded" (pending).

            # lv jun个人添加，防止取消停止单之后依旧走此逻辑
            num -= 1
            if len(self.active_limit_orders.values()) == num - 1:
                continue
            # 结束
    ...
    def cross_stop_order(self):
        ...
        # lv jun个人所加
        num = len(self.active_stop_orders.values())
        # 结束
        ...
        for stop_order in list(self.active_stop_orders.values()):
            ...
            # lv jun个人添加，防止取消停止单之后依旧走此逻辑
            num -= 1
            if len(self.active_stop_orders.values()) == num:
                continue
            # 结束
...
def optimize(
    ...
    return (vt_symbol + ' ' + str(setting), target_value, statistics)
