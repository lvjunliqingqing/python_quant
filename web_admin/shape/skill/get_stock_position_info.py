...
from shape.models.stock_position_data import StockPositionDataModel
from user.models import User


@csrf_exempt
def get_stock_position_info(request):
    """股票查询持仓信息"""
    if request.method == 'POST':
        ...
        query_set = StockPositionDataModel().get_position_info(account_id=account_id)
        if query_set:
            for i in query_set:
