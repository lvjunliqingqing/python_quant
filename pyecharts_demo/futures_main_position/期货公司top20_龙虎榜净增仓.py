...
if __name__ == "__main__":
    ...
    for security in main_price_relationship.main_all_security:
        ...
        sell_main_position_df = sell_main_position_df[sell_main_position_df["member_name"].isin(futures_company_top20)]
        ...
        buy_volume_series = buy_main_position_df.groupby(["trade_date"])["indicator_increase"].sum()
        sell_volume_series = sell_main_position_df.groupby(["trade_date"])["indicator_increase"].sum()
        ...
        if not m_p_d_df.empty:
            ...
            series_name = "期货公司top20主力每日净增仓"
            filename = f"html_chart/期货公司top20_龙虎榜净增仓/{data['security']}期货公司top20_龙虎榜净增仓与股价的关系.html"
            title = f"{data['security']}期货公司top20_龙虎榜净增仓与股价的关系"
