...
if __name__ == "__main__":
    ...
    for security in main_price_relationship.main_all_security:
        ...
        if not m_p_d_df.empty:
            ...
            series_name = "期货公司top20主力净持仓"
            filename = f"html_chart/期货公司top20_龙虎榜净持仓/{data['security']}期货公司top20_龙虎榜净持仓与股价的关系.html"
            title = f"{data['security']}期货公司top20_龙虎榜净持仓与股价的关系"
